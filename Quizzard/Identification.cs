...
namespace Quizzard
{
    class Identification : Quiz
    {
        ...
        public override void Save()
        {
            base.Save();
            XMLFileHandling fh = new XMLFileHandling();
            fh.AddIdentificationElement(Questions, CorrectAnswers, Hints, AlternateAnswers, QuizID, IsInOrder, IsAlternateAnswersEnabled, IsHintEnabled);
        }
